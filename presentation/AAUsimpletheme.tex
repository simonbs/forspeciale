...
%For Handouts
%\documentclass[10pt,handout]{beamer} %For printing
%\usepackage{pgf}
%\usepackage{pgfpages}
%\pgfpagesuselayout{4 on 1}[a4paper, border shrink = 2mm, landscape]
%\pgfpageslogicalpageoptions{1}{border code=\pgfusepath{stroke}} %Frames around slides
...
\include{content/gesturesandpointing}
\include{content/orientation}
\include{content/indorpositioning}

\include{content/evaluation}
\include{content/conlusion}
