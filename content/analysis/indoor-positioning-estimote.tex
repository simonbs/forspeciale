...
Also notice that \Cref{fig:estimote-location-configuration:actual} only has four beacons, 
whereas \Cref{fig:estimote-location-configuration:estimate} has six beacons. 
