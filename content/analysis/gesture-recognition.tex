...
The scoring equation is shown in \Cref{eq:gesture-scoring}.
...
To lessen the occurences of false positives the scoring heuristic explained in \Cref{three-dollar-heuristic} is used.
