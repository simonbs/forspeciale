...
We test it with the four settings from \Cref{table:rooms}.
...
We also tried to perform tests with eight beacons in this room, 
...
The first theory is that the Estimote SDK only uses a subset of beacons, \eg only four, for accuracy. 
...
The change could be a result of Estimote changing from two sets of four beacons, 
...
With eight beacons in a $5 \times 10$ meter room, 
