...
When using the system with all components connected we found it to be inaccurate. We investigated this and found that the inaccurate positioning impacts the accuracy of the entire system almost exponentially as described in section \ref{sec:evaluation:system-correctness}.

Based on this we can conclude that the next step could be to look into alternatives for indoor positioning or possibly substitute the knowledge of the users position with other information about the context the user is in.
Another possible step to be taken is to port the solution to a wearable.
