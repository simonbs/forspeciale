...
Based on the third prototype we were able to perform tests of indoor positioning as described in \ref{}\todo[author=Simon]{Indsæt reference til test af Estimote}. Furthermore tests of gesture recognition on a smartphone was tested as described in \ref{}\todo[author=Simon]{Indsæt reference til performance tests af \$3}.
