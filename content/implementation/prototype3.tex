...
The accuracy of Estimote is explored in \Cref{sec:estimoteprecision} and the performance of the gesture recognition is explored in \Cref{sec:gestureperformance}.
