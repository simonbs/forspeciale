...
The purpose of the second prototype is to test the  indoor positioning of the user using Estimote beacons and determine if gesture recognition can be performed using the hardware of a smartphone.
...
We were able to point at one or more devices and send an action to the devices in order to flip between their two different states. Both the users position and the devices were simulated.
