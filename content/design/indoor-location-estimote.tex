...
Estimote, as described in \Cref{sec:indoor-positioning}, is one of the vendors of BLE beacons using the iBeacon. 
...
\todo[author=Thalley]{Indsæt nogle beskrivende tal til at forklare hvor ringe det faktisk var}
