...
\begin{description}
  ...
  \item[\yes Train gestures] It is possible to train gestures.
  \item[\yes Recognize gestures] We can recognize gestures using the \$3 Gesture Recognizer.
  \item[\yes Assign gestures to actions] We can add gestures to actions. 
...
\begin{description}
  ...
  \item[Limited battery usage] We did not test this. 
