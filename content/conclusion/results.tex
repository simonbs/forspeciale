...
We have developed an interactive system that uses a wearable device as a control for home automation. 
...
Our tests show that we need an accuracy of around \SI{0.6}{\meter} to be viable. 
