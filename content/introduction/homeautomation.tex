...
A smart device that is currently becoming more popular is the Nest thermostat \cite{NEST}. 
...
\todo[author=Thalley]{Insert Weave in this table}
\begin{table}
   \begin{description}
...
A company known as Reemo \cite{Reemo}, formerly Playtabase, has created a way of controlling smart devices in homes using gestures. 
