...
A critical sitation could be that the person has fallen and are not responding to contact, for example calls.
...
The system may adapt its set of rules based on the environment and that behaviour of the individual.
