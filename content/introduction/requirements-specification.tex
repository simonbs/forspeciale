...
\begin{description}
    \item[Realtime gesture recognition] The system should recognize gestures effectively to give the user a feeling of realtime control of devices. We set a computational requirement of less than \SI{200}{\milli\second} per gesture. %Thalley: Should we define a maximum computational time? 
...
\begin{description}
    ...
    \item[Limited battery usage] Our system should be usable throughout the day, without requiring recharging of devices. 
